...
public class EditProjectPanel extends JPanel {
	...
	private JButton company,clients,projects,employees,invoices,reports,addNewProfessor,back,exitButton,help;
	public EditProjectPanel(final JFrame currentGUIFrame,final String seletedIndex,final SessionManager sessionManager) {
		setLayout(null);		
