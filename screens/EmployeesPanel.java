...
public class EmployeesPanel extends JPanel {
	...
	private JButton help,company,clients,projects,employees,invoices,reports,addnewemployee,editButton,deleteButton,exitButton;
	...
	public EmployeesPanel(final JFrame currentGUIFrame,final SessionManager sessionManager) {
		...
		ArrayList employeeList=myDatabaseHelper.getEmployees();
...
//					currentGUIFrame.getContentPane().removeAll();
//					//currentGUIFrame.getContentPane().add(new EditEmployeePanel(currentGUIFrame,selectedIndex,sessionManager));
//					currentGUIFrame.getContentPane().repaint();
//					selectedIndex="";
//				}else{
