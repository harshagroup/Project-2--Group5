...
public class ClientsPanel extends JPanel {
	...
	private JButton company,clients,projects,employees,invoices,reports,addnewclient,deleteButton,exitButton,editButton,help;
	...
	public ClientsPanel(final JFrame currentGUIFrame,final SessionManager sessionManager){
		...
		ArrayList clientList=myDatabaseHelper.getClients();
...
//					currentGUIFrame.getContentPane().removeAll();
//					//currentGUIFrame.getContentPane().add(new EditClientPanel(currentGUIFrame,selectedIndex,sessionManager));
//					currentGUIFrame.getContentPane().repaint();
//					selectedIndex="";
//				}else{
