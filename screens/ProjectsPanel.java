...
public class ProjectsPanel extends JPanel {
	...
	private JButton help,company,clients,projects,employees,invoices,reports,editButton,deleteButton,exitButton,addnewproject;
	...
	public ProjectsPanel(final JFrame currentGUIFrame,final SessionManager sessionManager) {
		...
		ArrayList projectList=myDatabaseHelper.getProjects();
...
//					currentGUIFrame.getContentPane().removeAll();
//					//currentGUIFrame.getContentPane().add(new EditProjectPanel(currentGUIFrame,selectedIndex,sessionManager));
//					currentGUIFrame.getContentPane().repaint();
//					selectedIndex="";
//				}else{
