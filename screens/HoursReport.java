...
public class HoursReport extends JPanel {
	...
	private JButton help,company,clients,projects,employees,invoices,reports,studentReport,facultyReport,exitButton,degreePlanReport;
	public HoursReport(final JFrame currentGUIFrame,final SessionManager sessionManager) {
		...
		Object columnNames[] = { "Client Name", "Project Name", "Developer Name", "Worked Hours", "Bill Rate", "Ämount"};
